 ...
 * and the Playwright PDF so they are pixel-identical. Tuned for US Letter, embedded
 * photos, and clean page breaks between observations (spec §3, §6).
 */
export const REPORT_CSS = `
:root{
  --ink:#16201c; --muted:#5b6b63; --line:#d8e0db; --accent:#0f3d2e;
  --accent-soft:#eaf1ed; --bg:#ffffff; --chip:#e7efe9;
}
*{box-sizing:border-box}
html,body{margin:0;padding:0;background:#f3f5f4;color:var(--ink);
...
.brand .mark{width:34px;height:34px;border-radius:8px;background:var(--accent);color:#fff;
  font-weight:800;font-size:14px;display:flex;align-items:center;justify-content:center;letter-spacing:.5px;}
...
.meta .project{font-size:16px;color:var(--ink);font-weight:700;}
...
/* Observation */
.obs{border:1px solid var(--line);border-radius:10px;overflow:hidden;margin-bottom:16px;
  break-inside:avoid;page-break-inside:avoid;}
.obs-head{display:flex;align-items:center;gap:10px;padding:9px 14px;background:#fafbfb;border-bottom:1px solid var(--line);}
.obs-num{width:24px;height:24px;border-radius:50%;background:var(--accent);color:#fff;font-size:12px;font-weight:700;
  display:flex;align-items:center;justify-content:center;flex:none;}
.obs-chips{display:flex;gap:6px;flex-wrap:wrap;margin-left:auto;}
.chip{font-size:10.5px;font-weight:600;color:var(--accent);background:var(--chip);border-radius:999px;padding:3px 9px;letter-spacing:.02em;}
...
.photos img{width:100%;height:auto;max-height:3.6in;object-fit:cover;border-radius:7px;border:1px solid var(--line);display:block;}
...
.report-footer .badge{font-weight:600;color:var(--accent);}

.draft-banner{background:#fff4e5;border:1px solid #f0c992;color:#8a5a12;font-size:12px;font-weight:600;
  border-radius:8px;padding:8px 12px;margin-bottom:18px;text-align:center;}
